...
// Validation schema — adjust rules here if your requirements change,
// and drop the `name` field entirely if registerUser doesn't use it.
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validate before touching the server at all
